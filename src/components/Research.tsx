  ...
  const researches: Research[] = [
    {
      ...
      leadResearcher: 'Dra. María Elena Ramos',
      team: ['Ing. José Pérez', 'Ing. Carmen Díaz', 'Bach. Luis Mendoza'],
      status: 'en-progreso',
    ...
    },
    {
      ...
      team: ['Ing. Ana Lucía Torres', 'Ing. Miguel Ángel Ruiz'],
      status: 'en-progreso',
    ...
    },
    {
      ...
      team: ['Mg. Carlos Mendoza', 'Ing. Laura Jiménez', 'Bach. Pedro Silva'],
      status: 'completado',
